...
export default class Client extends AkairoClient {
    ...
    public commandHandler: CommandHandler = new CommandHandler(this, {
        ...
        prefix: message => {if(message.guild == null){return process.env.PREFIX} else if(db.fetch(`${message.guild.id}_pf`)){ return db.fetch(`${message.guild.id}_pf`) } else { return process.env.PREFIX}},
        aliasReplacement: /-g/,
        allowMention: true,
        handleEdits: true,
        commandUtil: true,
