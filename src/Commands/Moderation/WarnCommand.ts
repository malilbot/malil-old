...
export default class WarnCommand extends Command {
	...
	public async exec(message: Message, { reason }) {
		...
		await user.send(`You has been Warned in **${message.guild.name}** for : \`${reason}\``).catch((e) => message.reply("Couldnt send a message to this usser but he has been warned"));
		//* ------------------------------------ infraction code */
